...
{ 
	SDK_UNDEFINED(80,478) /* TSet<FString> */          __um(StrSet);                                               // 0x0000   (0x0050)  
	SDK_UNDEFINED(80,479) /* TSet<int32_t> */          __um(IntSet);                                               // 0x0050   (0x0050)  
	SDK_UNDEFINED(80,480) /* TSet<FName> */            __um(NameSet);                                              // 0x00A0   (0x0050)  
	SDK_UNDEFINED(80,481) /* TSet<FStructSerializerBuiltinTestStruct> */ __um(StructSet);                          // 0x00F0   (0x0050)  
};
