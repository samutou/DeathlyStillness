...
public:
	...
	// bool RequestPrivilegeAsync(EMagicLeapPrivilege Privilege, FDelegateProperty& ResultDelegate);                            // [0xb30d40] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPrivileges.MagicLeapPrivilegesFunctionLibrary.RequestPrivilege
	// bool RequestPrivilege(EMagicLeapPrivilege Privilege);                                                                    // [0xb30cc0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapPrivileges.MagicLeapPrivilegesFunctionLibrary.CheckPrivilege
	// bool CheckPrivilege(EMagicLeapPrivilege Privilege);                                                                      // [0xb30cc0] Final|Native|Static|Public|BlueprintCallable 
};
