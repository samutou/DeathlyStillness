...
public:
	...
	// void ExportToDisk(class UTexture* Texture, FString Filename, FImageWriteOptions& Options);                               // [0x12cf4b0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
{ 
	...
	SDK_UNDEFINED(16,370) /* FDelegateProperty */      __um(OnComplete);                                           // 0x0004   (0x0010)  
