...
public:
	...
	SDK_UNDEFINED(16,416) /* FMulticastInlineDelegate */ __um(OnSetImageTargetSucceeded);                          // 0x0218   (0x0010)  
	SDK_UNDEFINED(16,417) /* FMulticastInlineDelegate */ __um(OnSetImageTargetFailed);                             // 0x0228   (0x0010)  
	SDK_UNDEFINED(16,418) /* FMulticastInlineDelegate */ __um(OnImageTargetFound);                                 // 0x0238   (0x0010)  
	SDK_UNDEFINED(16,419) /* FMulticastInlineDelegate */ __um(OnImageTargetLost);                                  // 0x0248   (0x0010)  
	SDK_UNDEFINED(16,420) /* FMulticastInlineDelegate */ __um(OnImageTargetUnreliableTracking);                    // 0x0258   (0x0010)  
	...
	// bool SetTargetAsync(class UTexture2D* ImageTarget);                                                                      // [0xb2d8b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeapImageTracker.MagicLeapImageTrackerComponent.RemoveTargetAsync
	// bool RemoveTargetAsync();                                                                                                // [0xb2d800] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SetMaxSimultaneousTargets(int32_t MaxSimultaneousTargets);                                                          // [0xb2d830] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.IsImageTrackingEnabled
	// bool IsImageTrackingEnabled();                                                                                           // [0xb2d7d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.GetMaxSimultaneousTargets
	// int32_t GetMaxSimultaneousTargets();                                                                                     // [0xb2d7a0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary.EnableImageTracking
	// void EnableImageTracking(bool bEnable);                                                                                  // [0xb2d720] Final|Native|Static|Public|BlueprintCallable 
};
