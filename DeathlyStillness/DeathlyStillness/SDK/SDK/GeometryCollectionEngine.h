...
public:
	...
	SDK_UNDEFINED(80,346) /* TSet<AChaosSolverActor*> */ __um(ChaosSolverActors);                                  // 0x0248   (0x0050)  
	SDK_UNDEFINED(80,347) /* TSet<AGeometryCollectionActor*> */ __um(GeometryCollectionActors);                    // 0x0298   (0x0050)  
	SDK_UNDEFINED(16,348) /* FMulticastInlineDelegate */ __um(OnCollisionEvents);                                  // 0x02E8   (0x0010)  
	SDK_UNDEFINED(16,349) /* FMulticastInlineDelegate */ __um(OnBreakingEvents);                                   // 0x02F8   (0x0010)  
	SDK_UNDEFINED(16,350) /* FMulticastInlineDelegate */ __um(OnTrailingEvents);                                   // 0x0308   (0x0010)  
	...
	// void SortTrailingEvents(TArray<FChaosTrailingEventData>& TrailingEvents, EChaosTrailingSortMethod SortMethod);           // [0x2b92f80] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SortCollisionEvents
	// void SortCollisionEvents(TArray<FChaosCollisionEventData>& CollisionEvents, EChaosCollisionSortMethod SortMethod);       // [0x2b92e80] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SortBreakingEvents
	// void SortBreakingEvents(TArray<FChaosBreakingEventData>& BreakingEvents, EChaosBreakingSortMethod SortMethod);           // [0x2b92d80] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetTrailingEventRequestSettings
	// void SetTrailingEventRequestSettings(FChaosTrailingEventRequestSettings& InSettings);                                    // [0x2b92ce0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetTrailingEventEnabled
	// void SetTrailingEventEnabled(bool bIsEnabled);                                                                           // [0x2b92c50] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetCollisionEventRequestSettings
	// void SetCollisionEventRequestSettings(FChaosCollisionEventRequestSettings& InSettings);                                  // [0x2b92b20] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetCollisionEventEnabled
	// void SetCollisionEventEnabled(bool bIsEnabled);                                                                          // [0x2b92a90] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetBreakingEventRequestSettings
	// void SetBreakingEventRequestSettings(FChaosBreakingEventRequestSettings& InSettings);                                    // [0x2b929f0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetBreakingEventEnabled
	// void SetBreakingEventEnabled(bool bIsEnabled);                                                                           // [0x2b92960] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.RemoveGeometryCollectionActor
	// void RemoveGeometryCollectionActor(class AGeometryCollectionActor* GeometryCollectionActor);                             // [0x2b928d0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.RemoveChaosSolverActor
	// void RemoveChaosSolverActor(class AChaosSolverActor* ChaosSolverActor);                                                  // [0x7ce7e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.IsEventListening
	// bool IsEventListening();                                                                                                 // [0x2b925f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.AddGeometryCollectionActor
	// void AddGeometryCollectionActor(class AGeometryCollectionActor* GeometryCollectionActor);                                // [0x2b92300] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.AddChaosSolverActor
	// void AddChaosSolverActor(class AChaosSolverActor* ChaosSolverActor);                                                     // [0x7ce7e0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// bool RaycastSingle(FVector Start, FVector End, FHitResult& OutHit);                                                      // [0x2b92760] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
};
...
/// Size: 0x08F0 (2288 bytes) (0x000468 - 0x0008F0) align 16 MaxSize: 0x08F0
class UGeometryCollectionComponent : public UMeshComponent
{ 
public:
	unsigned char                                      UnknownData00_8[0x8];                                       // 0x0468   (0x0008)  MISSED
	class AChaosSolverActor*                           ChaosSolverActor;                                           // 0x0470   (0x0008)  
	unsigned char                                      UnknownData01_6[0xE0];                                      // 0x0478   (0x00E0)  MISSED
	class UGeometryCollection*                         RestCollection;                                             // 0x0558   (0x0008)  
	TArray<class AFieldSystemActor*>                   InitializationFields;                                       // 0x0560   (0x0010)  
	bool                                               Simulating;                                                 // 0x0570   (0x0001)  
	unsigned char                                      UnknownData02_6[0x7];                                       // 0x0571   (0x0007)  MISSED
	EObjectStateTypeEnum                               ObjectType;                                                 // 0x0578   (0x0001)  
	bool                                               EnableClustering;                                           // 0x0579   (0x0001)  
	unsigned char                                      UnknownData03_6[0x2];                                       // 0x057A   (0x0002)  MISSED
	...
	unsigned char                                      UnknownData06_6[0x4];                                       // 0x05AC   (0x0004)  MISSED
	class UChaosPhysicalMaterial*                      PhysicalMaterial;                                           // 0x05B0   (0x0008)  
	EInitialVelocityTypeEnum                           InitialVelocityType;                                        // 0x05B8   (0x0001)  
	unsigned char                                      UnknownData07_6[0x3];                                       // 0x05B9   (0x0003)  MISSED
	FVector                                            InitialLinearVelocity;                                      // 0x05BC   (0x000C)  
	FVector                                            InitialAngularVelocity;                                     // 0x05C8   (0x000C)  
	unsigned char                                      UnknownData08_6[0x4];                                       // 0x05D4   (0x0004)  MISSED
	class UPhysicalMaterial*                           PhysicalMaterialOverride;                                   // 0x05D8   (0x0008)  
	FGeomComponentCacheParameters                      CacheParameters;                                            // 0x05E0   (0x0050)  
	SDK_UNDEFINED(16,351) /* FMulticastInlineDelegate */ __um(NotifyGeometryCollectionPhysicsStateChange);         // 0x0630   (0x0010)  
	SDK_UNDEFINED(16,352) /* FMulticastInlineDelegate */ __um(NotifyGeometryCollectionPhysicsLoadingStateChange);  // 0x0640   (0x0010)  
	unsigned char                                      UnknownData09_6[0x18];                                      // 0x0650   (0x0018)  MISSED
	SDK_UNDEFINED(16,353) /* FMulticastInlineDelegate */ __um(OnChaosBreakEvent);                                  // 0x0668   (0x0010)  
	float                                              DesiredCacheTime;                                           // 0x0678   (0x0004)  
	bool                                               CachePlayback;                                              // 0x067C   (0x0001)  
	unsigned char                                      UnknownData10_6[0x3];                                       // 0x067D   (0x0003)  MISSED
	SDK_UNDEFINED(16,354) /* FMulticastInlineDelegate */ __um(OnChaosPhysicsCollision);                            // 0x0680   (0x0010)  
	...
	unsigned char                                      UnknownData11_6[0x218];                                     // 0x06B0   (0x0218)  MISSED
	class UBodySetup*                                  DummyBodySetup;                                             // 0x08C8   (0x0008)  
	unsigned char                                      UnknownData12_7[0x20];                                      // 0x08D0   (0x0020)  MISSED


	/// Functions
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.SetNotifyBreaks
	// void SetNotifyBreaks(bool bNewNotifyBreaks);                                                                             // [0x2b92bc0] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.ReceivePhysicsCollision
	// void ReceivePhysicsCollision(FChaosPhysicsCollisionInfo& CollisionInfo);                                                 // [0xfa36a0] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.OnRep_RepData
	// void OnRep_RepData(FGeometryCollectionRepData& OldData);                                                                 // [0x2b926b0] Final|Native|Protected|HasOutParms 
	...
	// void NotifyGeometryCollectionPhysicsStateChange__DelegateSignature(class UGeometryCollectionComponent* FracturedComponent); // [0xfa36a0] MulticastDelegate|Public|Delegate 
	...
	// void NotifyGeometryCollectionPhysicsLoadingStateChange__DelegateSignature(class UGeometryCollectionComponent* FracturedComponent); // [0xfa36a0] MulticastDelegate|Public|Delegate 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.NetAbandonCluster
	// void NetAbandonCluster(int32_t TransformIndex);                                                                          // [0x2b92620] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.ApplyPhysicsField
	// void ApplyPhysicsField(bool Enabled, EGeometryCollectionPhysicsTypeEnum Target, class UFieldSystemMetaData* MetaData, class UFieldNodeBase* Field); // [0x2b92470] Final|Native|Public|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.GeometryCollectionComponent.ApplyKinematicField
	// void ApplyKinematicField(float Radius, FVector Position);                                                                // [0x2b92390] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(16,355) /* FMulticastInlineDelegate */ __um(OnChaosPhysicsCollision);                            // 0x0118   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,356) /* FMulticastInlineDelegate */ __um(OnChaosPhysicsCollision);                            // 0x0100   (0x0010)  
	...
	// void ForceRecreatePhysicsState();                                                                                        // [0x2b925d0] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UGeometryCollectionComponent) == 0x08F0); // 2288 bytes (0x000468 - 0x0008F0)
...
static_assert(offsetof(UGeometryCollectionComponent, ChaosSolverActor) == 0x0470);
static_assert(offsetof(UGeometryCollectionComponent, RestCollection) == 0x0558);
static_assert(offsetof(UGeometryCollectionComponent, InitializationFields) == 0x0560);
static_assert(offsetof(UGeometryCollectionComponent, ObjectType) == 0x0578);
static_assert(offsetof(UGeometryCollectionComponent, DamageThreshold) == 0x0588);
static_assert(offsetof(UGeometryCollectionComponent, ClusterConnectionType) == 0x0598);
static_assert(offsetof(UGeometryCollectionComponent, PhysicalMaterial) == 0x05B0);
static_assert(offsetof(UGeometryCollectionComponent, InitialVelocityType) == 0x05B8);
static_assert(offsetof(UGeometryCollectionComponent, InitialLinearVelocity) == 0x05BC);
static_assert(offsetof(UGeometryCollectionComponent, InitialAngularVelocity) == 0x05C8);
static_assert(offsetof(UGeometryCollectionComponent, PhysicalMaterialOverride) == 0x05D8);
static_assert(offsetof(UGeometryCollectionComponent, CacheParameters) == 0x05E0);
static_assert(offsetof(UGeometryCollectionComponent, RepData) == 0x0698);
static_assert(offsetof(UGeometryCollectionComponent, DummyBodySetup) == 0x08C8);
