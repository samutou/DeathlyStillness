...
public:
	...
	SDK_UNDEFINED(16,421) /* FMulticastInlineDelegate */ __um(OnPlanesQueryResult);                                // 0x0228   (0x0010)  
	SDK_UNDEFINED(16,422) /* FMulticastInlineDelegate */ __um(OnPersistentPlanesQueryResult);                      // 0x0238   (0x0010)  
	...
	// bool RequestPlanesAsync();                                                                                               // [0xb307b0] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void ReorderPlaneFlags(TArray<EMagicLeapPlaneQueryFlags>& InPriority, TArray<EMagicLeapPlaneQueryFlags>& InFlagsToReorder, TArray<EMagicLeapPlaneQueryFlags>& OutReorderedFlags); // [0xb30630] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.RemovePersistentQuery
	// bool RemovePersistentQuery(FGuid Handle);                                                                                // [0xb30590] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.RemoveFlagsNotInQuery
	// void RemoveFlagsNotInQuery(TArray<EMagicLeapPlaneQueryFlags>& InQueryFlags, TArray<EMagicLeapPlaneQueryFlags>& InResultFlags, TArray<EMagicLeapPlaneQueryFlags>& OutFlags); // [0xb30410] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.PlanesQueryBeginAsync
	// bool PlanesQueryBeginAsync(FMagicLeapPlanesQuery& Query, FDelegateProperty& ResultDelegate);                             // [0xb302b0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.PlanesPersistentQueryBeginAsync
	// bool PlanesPersistentQueryBeginAsync(FMagicLeapPlanesQuery& Query, FGuid& Handle, FDelegateProperty& ResultDelegate);    // [0xb30100] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.IsTrackerValid
	// bool IsTrackerValid();                                                                                                   // [0xb300d0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.GetContentScale
	// FTransform GetContentScale(class AActor* ContentActor, FMagicLeapPlaneResult& PlaneResult);                              // [0xb2ff80] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.DestroyTracker
	// bool DestroyTracker();                                                                                                   // [0xb2ff50] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.CreateTracker
	// bool CreateTracker();                                                                                                    // [0xb2ff20] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeapPlanes.MagicLeapPlanesFunctionLibrary.AddPersistentQuery
	// FGuid AddPersistentQuery(EMagicLeapPlaneQueryType PersistentQueryType);                                                  // [0xb2fe90] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
