...
public:
	...
	// void StartLuminARSession(class UObject* WorldContextObject, FLatentActionInfo LatentInfo, class ULuminARSessionConfig* Configuration); // [0xb12f40] Final|Native|Static|Public|BlueprintCallable 
};
...
public:
	...
	// bool LuminARLineTrace(class UObject* WorldContextObject, FVector2D& ScreenPosition, TSet<ELuminARLineTraceChannel> TraceChannels, TArray<FARTraceResult>& OutHitResults); // [0xb12cd0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeapAR.LuminARFrameFunctionLibrary.GetTrackingState
	// ELuminARTrackingState GetTrackingState();                                                                                // [0xb12c80] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
...
public:
	...
	// TArray<float> GetAmbientIntensityNits();                                                                                 // [0xb12b80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// bool GetUseUnreliablePose();                                                                                             // [0xb12cb0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MagicLeapAR.LuminARCandidateImage.GetImageIsStationary
	// bool GetImageIsStationary();                                                                                             // [0xb12c60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/MagicLeapAR.LuminARCandidateImage.GetAxisOrientation
	// EMagicLeapImageTargetOrientation GetAxisOrientation();                                                                   // [0xb12c40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
