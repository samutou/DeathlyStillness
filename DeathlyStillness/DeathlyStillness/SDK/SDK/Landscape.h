...
/// Size: 0x04E0 (1248 bytes) (0x0004D0 - 0x0004E0) align 16 MaxSize: 0x04E0
class UControlPointMeshComponent : public UStaticMeshComponent
{ 
public:
	float                                              VirtualTextureMainPassMaxDrawDistance;                      // 0x04D0   (0x0004)  
	unsigned char                                      UnknownData00_7[0xC];                                       // 0x04D4   (0x000C)  MISSED
};
...
public:
	...
	// void SetLandscapeMaterialVectorParameterValue(FName ParameterName, FLinearColor Value);                                  // [0x1d81fb0] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialTextureParameterValue
	// void SetLandscapeMaterialTextureParameterValue(FName ParameterName, class UTexture* Value);                              // [0x1d81ee0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialScalarParameterValue
	// void SetLandscapeMaterialScalarParameterValue(FName ParameterName, float Value);                                         // [0x1d81e10] Final|RequiredAPI|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.LandscapeExportHeightmapToRenderTarget
	// bool LandscapeExportHeightmapToRenderTarget(class UTextureRenderTarget2D* InRenderTarget, bool InExportHeightIntoRGChannel, bool InExportLandscapeProxies); // [0x1d81cf0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.EditorSetLandscapeMaterial
	// void EditorSetLandscapeMaterial(class UMaterialInterface* NewLandscapeMaterial);                                         // [0x7ce7e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.EditorApplySpline
	// void EditorApplySpline(class USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float StartRoll, float EndRoll, int32_t NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, class ULandscapeLayerInfoObject* PaintLayer, FName EditLayerName); // [0x1d81960] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeUseTessellationComponentScreenSizeFalloff
	// void ChangeUseTessellationComponentScreenSizeFalloff(bool InComponentScreenSizeToUseSubSections);                        // [0x1d818d0] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeTessellationComponentScreenSizeFalloff
	// void ChangeTessellationComponentScreenSizeFalloff(float InUseTessellationComponentScreenSizeFalloff);                    // [0x1d81840] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeTessellationComponentScreenSize
	// void ChangeTessellationComponentScreenSize(float InTessellationComponentScreenSize);                                     // [0x1d817b0] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeLODDistanceFactor
	// void ChangeLODDistanceFactor(float InLODDistanceFactor);                                                                 // [0x1d81720] Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeProxy.ChangeComponentScreenSizeToUseSubSections
	// void ChangeComponentScreenSizeToUseSubSections(float InComponentScreenSizeToUseSubSections);                             // [0x1d81690] Native|Public|BlueprintCallable 
};
...
public:
	...
	// void RequestLandscapeUpdate();                                                                                           // [0x7dd9b0] Final|Native|Public|BlueprintCallable 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.Render
	// class UTextureRenderTarget2D* Render(bool InIsHeightmap, class UTextureRenderTarget2D* InCombinedResult, FName& InWeightmapLayerName); // [0x1d80090] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.Initialize
	// void Initialize(FTransform& InLandscapeTransform, FIntPoint& InLandscapeSize, FIntPoint& InLandscapeRenderTargetSize);   // [0x1d7ff10] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.GetBlueprintRenderDependencies
	// void GetBlueprintRenderDependencies(TArray<UObject*>& OutStreamableAssets);                                              // [0xfa36a0] Event|Public|HasOutParms|BlueprintEvent 
};
...
/// Size: 0x0660 (1632 bytes) (0x000440 - 0x000660) align 16 MaxSize: 0x0660
...
public:
	...
	class UMaterialInterface*                          OverrideMaterial;                                           // 0x0458   (0x0008)  
	class UMaterialInterface*                          OverrideHoleMaterial;                                       // 0x0460   (0x0008)  
	TArray<FLandscapeComponentMaterialOverride>        OverrideMaterials;                                          // 0x0468   (0x0010)  
	TArray<class UMaterialInstanceConstant*>           MaterialInstances;                                          // 0x0478   (0x0010)  
	TArray<class UMaterialInstanceDynamic*>            MaterialInstancesDynamic;                                   // 0x0488   (0x0010)  
	...
	class UTexture2D*                                  XYOffsetmapTexture;                                         // 0x04B8   (0x0008)  
	FVector4                                           WeightmapScaleBias;                                         // 0x04C0   (0x0010)  
	float                                              WeightmapSubsectionOffset;                                  // 0x04D0   (0x0004)  
	unsigned char                                      UnknownData01_6[0xC];                                       // 0x04D4   (0x000C)  MISSED
	FVector4                                           HeightmapScaleBias;                                         // 0x04E0   (0x0010)  
	FBox                                               CachedLocalBox;                                             // 0x04F0   (0x001C)  
	TLazyObjectPtr<class ULandscapeHeightfieldCollisionComponent*> CollisionComponent;                             // 0x050C   (0x001C)  
	class UTexture2D*                                  HeightmapTexture;                                           // 0x0528   (0x0008)  
	TArray<FWeightmapLayerAllocationInfo>              WeightmapLayerAllocations;                                  // 0x0530   (0x0010)  
	TArray<class UTexture2D*>                          WeightmapTextures;                                          // 0x0540   (0x0010)  
	class ULandscapeLODStreamingProxy*                 LODStreamingProxy;                                          // 0x0550   (0x0008)  
	...
	class UTexture2D*                                  GIBakedBaseColorTexture;                                    // 0x05B8   (0x0008)  
	char                                               MobileBlendableLayerMask;                                   // 0x05C0   (0x0001)  
	unsigned char                                      UnknownData03_6[0x7];                                       // 0x05C1   (0x0007)  MISSED
	class UMaterialInterface*                          MobileMaterialInterface;                                    // 0x05C8   (0x0008)  
	TArray<class UMaterialInterface*>                  MobileMaterialInterfaces;                                   // 0x05D0   (0x0010)  
	TArray<class UTexture2D*>                          MobileWeightmapTextures;                                    // 0x05E0   (0x0010)  
	unsigned char                                      UnknownData04_7[0x70];                                      // 0x05F0   (0x0070)  MISSED


	/// Functions
	// Function /Script/Landscape.LandscapeComponent.GetMaterialInstanceDynamic
	// class UMaterialInstanceDynamic* GetMaterialInstanceDynamic(int32_t InIndex);                                             // [0x1d7fe40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Landscape.LandscapeComponent.EditorGetPaintLayerWeightByNameAtLocation
	// float EditorGetPaintLayerWeightByNameAtLocation(FVector& InLocation, FName InPaintLayerName);                            // [0x1d7fd60] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/Landscape.LandscapeComponent.EditorGetPaintLayerWeightAtLocation
	// float EditorGetPaintLayerWeightAtLocation(FVector& InLocation, class ULandscapeLayerInfoObject* PaintLayer);             // [0x1d7fc80] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
};
...
/// Size: 0x0440 (1088 bytes) (0x000440 - 0x000440) align 16 MaxSize: 0x0440
...
/// Size: 0x0520 (1312 bytes) (0x000440 - 0x000520) align 16 MaxSize: 0x0520
class ULandscapeHeightfieldCollisionComponent : public UPrimitiveComponent
{ 
public:
	TArray<class ULandscapeLayerInfoObject*>           ComponentLayerInfos;                                        // 0x0440   (0x0010)  
	...
	TLazyObjectPtr<class ULandscapeComponent*>         RenderComponent;                                            // 0x04A4   (0x001C)  
	unsigned char                                      UnknownData01_6[0x10];                                      // 0x04C0   (0x0010)  MISSED
	TArray<class UPhysicalMaterial*>                   CookedPhysicalMaterials;                                    // 0x04D0   (0x0010)  
	unsigned char                                      UnknownData02_7[0x40];                                      // 0x04E0   (0x0040)  MISSED


	/// Functions
	// Function /Script/Landscape.LandscapeHeightfieldCollisionComponent.GetRenderComponent
	// class ULandscapeComponent* GetRenderComponent();                                                                         // [0x1d7fee0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
/// Size: 0x0540 (1344 bytes) (0x000520 - 0x000540) align 16 MaxSize: 0x0540
...
/// Size: 0x0500 (1280 bytes) (0x0004D0 - 0x000500) align 16 MaxSize: 0x0500
...
/// Size: 0x0470 (1136 bytes) (0x000440 - 0x000470) align 16 MaxSize: 0x0470
class ULandscapeSplinesComponent : public UPrimitiveComponent
{ 
public:
	TArray<class ULandscapeSplineControlPoint*>        ControlPoints;                                              // 0x0440   (0x0010)  
	TArray<class ULandscapeSplineSegment*>             Segments;                                                   // 0x0450   (0x0010)  
	TArray<class UMeshComponent*>                      CookedForeignMeshComponents;                                // 0x0460   (0x0010)  


	/// Functions
	// Function /Script/Landscape.LandscapeSplinesComponent.GetSplineMeshComponents
	// TArray<USplineMeshComponent*> GetSplineMeshComponents();                                                                 // [0x1d83b90] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UControlPointMeshComponent) == 0x04E0); // 1248 bytes (0x0004D0 - 0x0004E0)
...
static_assert(sizeof(ULandscapeComponent) == 0x0660); // 1632 bytes (0x000440 - 0x000660)
...
static_assert(sizeof(ULandscapeGizmoRenderComponent) == 0x0440); // 1088 bytes (0x000440 - 0x000440)
...
static_assert(sizeof(ULandscapeHeightfieldCollisionComponent) == 0x0520); // 1312 bytes (0x000440 - 0x000520)
...
static_assert(sizeof(ULandscapeMeshCollisionComponent) == 0x0540); // 1344 bytes (0x000520 - 0x000540)
static_assert(sizeof(ALandscapeMeshProxyActor) == 0x0228); // 552 bytes (0x000220 - 0x000228)
static_assert(sizeof(ULandscapeMeshProxyComponent) == 0x0500); // 1280 bytes (0x0004D0 - 0x000500)
static_assert(sizeof(ULandscapeSettings) == 0x0040); // 64 bytes (0x000038 - 0x000040)
static_assert(sizeof(ULandscapeSplinesComponent) == 0x0470); // 1136 bytes (0x000440 - 0x000470)
...
static_assert(offsetof(ULandscapeComponent, OverrideMaterial) == 0x0458);
static_assert(offsetof(ULandscapeComponent, OverrideHoleMaterial) == 0x0460);
static_assert(offsetof(ULandscapeComponent, OverrideMaterials) == 0x0468);
static_assert(offsetof(ULandscapeComponent, MaterialInstances) == 0x0478);
static_assert(offsetof(ULandscapeComponent, MaterialInstancesDynamic) == 0x0488);
static_assert(offsetof(ULandscapeComponent, LODIndexToMaterialIndex) == 0x0498);
static_assert(offsetof(ULandscapeComponent, MaterialIndexToDisabledTessellationMaterial) == 0x04A8);
static_assert(offsetof(ULandscapeComponent, XYOffsetmapTexture) == 0x04B8);
static_assert(offsetof(ULandscapeComponent, WeightmapScaleBias) == 0x04C0);
static_assert(offsetof(ULandscapeComponent, HeightmapScaleBias) == 0x04E0);
static_assert(offsetof(ULandscapeComponent, CachedLocalBox) == 0x04F0);
static_assert(offsetof(ULandscapeComponent, CollisionComponent) == 0x050C);
static_assert(offsetof(ULandscapeComponent, HeightmapTexture) == 0x0528);
static_assert(offsetof(ULandscapeComponent, WeightmapLayerAllocations) == 0x0530);
static_assert(offsetof(ULandscapeComponent, WeightmapTextures) == 0x0540);
static_assert(offsetof(ULandscapeComponent, LODStreamingProxy) == 0x0550);
static_assert(offsetof(ULandscapeComponent, MapBuildDataId) == 0x0558);
static_assert(offsetof(ULandscapeComponent, IrrelevantLights) == 0x0568);
static_assert(offsetof(ULandscapeComponent, StateId) == 0x0594);
static_assert(offsetof(ULandscapeComponent, BakedTextureMaterialGuid) == 0x05A4);
static_assert(offsetof(ULandscapeComponent, GIBakedBaseColorTexture) == 0x05B8);
static_assert(offsetof(ULandscapeComponent, MobileMaterialInterface) == 0x05C8);
static_assert(offsetof(ULandscapeComponent, MobileMaterialInterfaces) == 0x05D0);
static_assert(offsetof(ULandscapeComponent, MobileWeightmapTextures) == 0x05E0);
...
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, ComponentLayerInfos) == 0x0440);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CollisionQuadFlags) == 0x0468);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, HeightfieldGuid) == 0x0478);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CachedLocalBox) == 0x0488);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, RenderComponent) == 0x04A4);
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, CookedPhysicalMaterials) == 0x04D0);
...
static_assert(offsetof(ULandscapeMeshCollisionComponent, MeshGuid) == 0x0520);
static_assert(offsetof(ALandscapeMeshProxyActor, LandscapeMeshProxyComponent) == 0x0220);
static_assert(offsetof(ULandscapeMeshProxyComponent, LandscapeGuid) == 0x04D0);
static_assert(offsetof(ULandscapeMeshProxyComponent, ProxyComponentBases) == 0x04E0);
static_assert(offsetof(ULandscapeSplinesComponent, ControlPoints) == 0x0440);
static_assert(offsetof(ULandscapeSplinesComponent, Segments) == 0x0450);
static_assert(offsetof(ULandscapeSplinesComponent, CookedForeignMeshComponents) == 0x0460);
