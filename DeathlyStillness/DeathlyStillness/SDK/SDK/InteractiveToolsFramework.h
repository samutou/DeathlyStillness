...
public:
	...
	SDK_UNDEFINED(16,371) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,372) /* TScriptInterface<Class> */ __um(AngleSource);                                         // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,373) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,374) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,375) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,376) /* TScriptInterface<Class> */ __um(ParameterSource);                                     // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,377) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,378) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
...
public:
	...
	// void UpdateWorldLocalState(bool bWorldIn);                                                                               // [0x2bb7a80] Final|Native|Public  
	// Function /Script/InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState
	// void UpdateHoverState(bool bHoveringIn);                                                                                 // [0x2bb79f0] Final|Native|Public  
};
...
/// Size: 0x04A0 (1184 bytes) (0x000460 - 0x0004A0) align 16 MaxSize: 0x04A0
...
public:
	...
	unsigned char                                      UnknownData01_7[0xE];                                       // 0x0492   (0x000E)  MISSED
};
...
public:
	...
	unsigned char                                      UnknownData00_7[0x6];                                       // 0x047A   (0x0006)  MISSED
};
...
public:
	...
	// void SetTransform(FTransform& NewTransform);                                                                             // [0x2bb7880] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoTransformSource.GetTransform
	// FTransform GetTransform();                                                                                               // [0x2bb76c0] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// bool HasTangentVectors();                                                                                                // [0x2bb7730] Native|Public|Const  
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors
	// void GetTangentVectors(FVector& TangentXOut, FVector& TangentYOut);                                                      // [0x2bb75d0] Native|Public|HasOutParms|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetOrigin
	// FVector GetOrigin();                                                                                                     // [0x2bb7520] Native|Public|HasDefaults|Const 
	// Function /Script/InteractiveToolsFramework.GizmoAxisSource.GetDirection
	// FVector GetDirection();                                                                                                  // [0x2bb74e0] Native|Public|HasDefaults|Const 
};
...
public:
	...
	// void UpdateHoverState(bool bHovering);                                                                                   // [0x2bb7960] Native|Public|Const  
};
...
public:
	...
	// void EndUpdate();                                                                                                        // [0x2bb7480] Native|Public        
	// Function /Script/InteractiveToolsFramework.GizmoStateTarget.BeginUpdate
	// void BeginUpdate();                                                                                                      // [0x2bb74a0] Native|Public        
};
...
public:
	...
	// void SetParameter(FVector2D& NewValue);                                                                                  // [0x2bb77f0] Native|Public|HasOutParms|HasDefaults 
	// Function /Script/InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter
	// FVector2D GetParameter();                                                                                                // [0x2bb7590] Native|Public|HasDefaults|Const 
...
/// Size: 0x0490 (1168 bytes) (0x000460 - 0x000490) align 16 MaxSize: 0x0490
...
public:
	...
	unsigned char                                      UnknownData00_7[0xB];                                       // 0x0485   (0x000B)  MISSED
};
...
{ 
public:
	SDK_UNDEFINED(16,379) /* TScriptInterface<Class> */ __um(FloatParameterSource);                                // 0x0048   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,380) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,381) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,382) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,383) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,384) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,385) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,386) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,387) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x0058   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,388) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,389) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x0058   (0x0010)  
	float                                              ScaleMultiplier;                                            // 0x0068   (0x0004)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,390) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,391) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,392) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,393) /* TScriptInterface<Class> */ __um(ParameterSource);                                     // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,394) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,395) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
	bool                                               bEnableSignedAxis;                                          // 0x0088   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(16,396) /* TScriptInterface<Class> */ __um(TransactionManager);                                  // 0x0050   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,397) /* TScriptInterface<Class> */ __um(ChildTransformSource);                                // 0x0048   (0x0010)  
...
static_assert(sizeof(UGizmoBaseComponent) == 0x0460); // 1120 bytes (0x000440 - 0x000460)
static_assert(sizeof(UGizmoArrowComponent) == 0x0480); // 1152 bytes (0x000460 - 0x000480)
static_assert(sizeof(UGizmoBoxComponent) == 0x04A0); // 1184 bytes (0x000460 - 0x0004A0)
static_assert(sizeof(UGizmoCircleComponent) == 0x0480); // 1152 bytes (0x000460 - 0x000480)
...
static_assert(sizeof(UGizmoLineHandleComponent) == 0x0490); // 1168 bytes (0x000460 - 0x000490)
static_assert(sizeof(UGizmoRectangleComponent) == 0x0490); // 1168 bytes (0x000460 - 0x000490)
...
static_assert(offsetof(UGizmoBaseComponent, Color) == 0x0440);
static_assert(offsetof(UGizmoArrowComponent, Direction) == 0x0460);
static_assert(offsetof(UGizmoBoxComponent, Origin) == 0x0460);
static_assert(offsetof(UGizmoBoxComponent, Rotation) == 0x0470);
static_assert(offsetof(UGizmoBoxComponent, Dimensions) == 0x0480);
static_assert(offsetof(UGizmoCircleComponent, Normal) == 0x0460);
static_assert(offsetof(UGizmoLineHandleComponent, Normal) == 0x0460);
static_assert(offsetof(UGizmoLineHandleComponent, Direction) == 0x0474);
static_assert(offsetof(UGizmoRectangleComponent, DirectionX) == 0x0460);
static_assert(offsetof(UGizmoRectangleComponent, DirectionY) == 0x046C);
