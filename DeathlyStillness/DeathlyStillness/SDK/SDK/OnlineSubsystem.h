...
public:
	...
	// void OnMatchReceivedTurn(FString Match, bool bDidBecomeActive);                                                          // [0xfa36a0] Event|Public|BlueprintEvent 
	// Function /Script/OnlineSubsystem.TurnBasedMatchInterface.OnMatchEnded
	// void OnMatchEnded(FString Match);                                                                                        // [0xfa36a0] Event|Public|BlueprintEvent 
};
