...
public:
	...
	// void TakeGameplayAutomationScreenshot(FString ScreenshotName, float MaxGlobalError, float MaxLocalError, FString MapNameOverride); // [0x7fe060] Final|Native|Static|Public|BlueprintCallable 
};
