...
/// Size: 0x06A0 (1696 bytes) (0x000668 - 0x0006A0) align 16 MaxSize: 0x06A0
class UFoliageInstancedStaticMeshComponent : public UHierarchicalInstancedStaticMeshComponent
{ 
public:
	SDK_UNDEFINED(16,357) /* FMulticastInlineDelegate */ __um(OnInstanceTakePointDamage);                          // 0x0668   (0x0010)  
	SDK_UNDEFINED(16,358) /* FMulticastInlineDelegate */ __um(OnInstanceTakeRadialDamage);                         // 0x0678   (0x0010)  
	FGuid                                              GenerationGuid;                                             // 0x0688   (0x0010)  
	unsigned char                                      UnknownData00_7[0x8];                                       // 0x0698   (0x0008)  MISSED
};
...
public:
	...
	// int32_t FoliageOverlappingSphereCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FVector CenterPosition, float Radius); // [0x1d48a60] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxCount
	// int32_t FoliageOverlappingBoxCount(class UObject* WorldContextObject, class UStaticMesh* StaticMesh, FBox Box);          // [0x1d48920] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	unsigned char                                      UnknownData13_6[0x2];                                       // 0x02B2   (0x0002)  MISSED
	bool                                               bRenderCustomDepth : 1;                                     // 0x02B4:0 (0x0001)  
	unsigned char                                      UnknownData14_5[0x3];                                       // 0x02B5   (0x0003)  MISSED
	ERendererStencilMask                               CustomDepthStencilWriteMask;                                // 0x02B8   (0x0001)  
	unsigned char                                      UnknownData15_6[0x3];                                       // 0x02B9   (0x0003)  MISSED
	...
	unsigned char                                      UnknownData16_6[0x2];                                       // 0x02EA   (0x0002)  MISSED
	...
	bool                                               ReapplyDensity : 1;                                         // 0x038C:0 (0x0001)  
	bool                                               ReapplyRadius : 1;                                          // 0x038C:1 (0x0001)  
	bool                                               ReapplyAlignToNormal : 1;                                   // 0x038C:2 (0x0001)  
	bool                                               ReapplyRandomYaw : 1;                                       // 0x038C:3 (0x0001)  
	bool                                               ReapplyScaling : 1;                                         // 0x038C:4 (0x0001)  
	bool                                               ReapplyScaleX : 1;                                          // 0x038C:5 (0x0001)  
	bool                                               ReapplyScaleY : 1;                                          // 0x038C:6 (0x0001)  
	bool                                               ReapplyScaleZ : 1;                                          // 0x038C:7 (0x0001)  
	bool                                               ReapplyRandomPitchAngle : 1;                                // 0x038D:0 (0x0001)  
	bool                                               ReapplyGroundSlope : 1;                                     // 0x038D:1 (0x0001)  
	bool                                               ReapplyHeight : 1;                                          // 0x038D:2 (0x0001)  
	bool                                               ReapplyLandscapeLayers : 1;                                 // 0x038D:3 (0x0001)  
	bool                                               ReapplyZOffset : 1;                                         // 0x038D:4 (0x0001)  
	bool                                               ReapplyCollisionWithWorld : 1;                              // 0x038D:5 (0x0001)  
	bool                                               ReapplyVertexColorMask : 1;                                 // 0x038D:6 (0x0001)  
	bool                                               bEnableDensityScaling : 1;                                  // 0x038D:7 (0x0001)  
	bool                                               bEnableDiscardOnLoad : 1;                                   // 0x038E:0 (0x0001)  
	unsigned char                                      UnknownData17_5[0x1];                                       // 0x038F   (0x0001)  MISSED
	TArray<class URuntimeVirtualTexture*>              RuntimeVirtualTextures;                                     // 0x0390   (0x0010)  
	...
	unsigned char                                      UnknownData18_7[0x3];                                       // 0x03A5   (0x0003)  MISSED
};
...
{ 
public:
	class UClass*                                      ActorClass;                                                 // 0x03A8   (0x0008)  
...
/// Size: 0x03C8 (968 bytes) (0x0003A8 - 0x0003C8) align 8 MaxSize: 0x03C8
class UFoliageType_InstancedStaticMesh : public UFoliageType
{ 
public:
	class UStaticMesh*                                 Mesh;                                                       // 0x03A8   (0x0008)  
	TArray<class UMaterialInterface*>                  OverrideMaterials;                                          // 0x03B0   (0x0010)  
	class UClass*                                      ComponentClass;                                             // 0x03C0   (0x0008)  
};
...
public:
	...
	// void CapsuleTouched(class UPrimitiveComponent* OverlappedComp, class AActor* Other, class UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& OverlapInfo); // [0x1d48710] Final|Native|Protected|HasOutParms 
};
...
public:
	...
	// void Simulate(int32_t NumSteps);                                                                                         // [0x1d48bc0] Final|Native|Public|BlueprintCallable 
};
...
static_assert(sizeof(UFoliageInstancedStaticMeshComponent) == 0x06A0); // 1696 bytes (0x000668 - 0x0006A0)
...
static_assert(sizeof(UInteractiveFoliageComponent) == 0x04E0); // 1248 bytes (0x0004D0 - 0x0004E0)
...
static_assert(offsetof(UFoliageInstancedStaticMeshComponent, GenerationGuid) == 0x0688);
