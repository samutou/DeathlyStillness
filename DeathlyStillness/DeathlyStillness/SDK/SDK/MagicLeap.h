...
{ 
public:
	SDK_UNDEFINED(16,399) /* FMulticastInlineDelegate */ __um(InAppPurchaseLogMessage);                            // 0x00B0   (0x0010)  
	SDK_UNDEFINED(16,400) /* FMulticastInlineDelegate */ __um(GetItemsDetailsSuccess);                             // 0x00C0   (0x0010)  
	SDK_UNDEFINED(16,401) /* FMulticastInlineDelegate */ __um(GetItemsDetailsFailure);                             // 0x00D0   (0x0010)  
	SDK_UNDEFINED(16,402) /* FMulticastInlineDelegate */ __um(PurchaseConfirmationSuccess);                        // 0x00E0   (0x0010)  
	SDK_UNDEFINED(16,403) /* FMulticastInlineDelegate */ __um(PurchaseConfirmationFailure);                        // 0x00F0   (0x0010)  
	SDK_UNDEFINED(16,404) /* FMulticastInlineDelegate */ __um(GetPurchaseHistorySuccess);                          // 0x0100   (0x0010)  
	SDK_UNDEFINED(16,405) /* FMulticastInlineDelegate */ __um(GetPurchaseHistoryFailure);                          // 0x0110   (0x0010)  
	...
	// bool TryPurchaseItemAsync(FPurchaseItemDetails& ItemDetails);                                                            // [0xb0dea0] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeap.InAppPurchaseComponent.TryGetPurchaseHistoryAsync
	// bool TryGetPurchaseHistoryAsync(int32_t InNumPages);                                                                     // [0xb0de00] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeap.InAppPurchaseComponent.TryGetItemsDetailsAsync
	// bool TryGetItemsDetailsAsync(TArray<FString>& ItemIDs);                                                                  // [0xb0dd20] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeap.InAppPurchaseComponent.PurchaseConfirmationSuccess__DelegateSignature
	// void PurchaseConfirmationSuccess__DelegateSignature(FPurchaseConfirmation& PurchaseConfirmations);                       // [0xfa36a0] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/MagicLeap.InAppPurchaseComponent.PurchaseConfirmationFailure__DelegateSignature
	// void PurchaseConfirmationFailure__DelegateSignature();                                                                   // [0xfa36a0] MulticastDelegate|Public|Delegate 
	// Function /Script/MagicLeap.InAppPurchaseComponent.InAppPurchaseLogMessage__DelegateSignature
	// void InAppPurchaseLogMessage__DelegateSignature(FString LogMessage);                                                     // [0xfa36a0] MulticastDelegate|Public|Delegate 
	// Function /Script/MagicLeap.InAppPurchaseComponent.GetPurchaseHistorySuccess__DelegateSignature
	// void GetPurchaseHistorySuccess__DelegateSignature(TArray<FPurchaseConfirmation>& PurchaseHistory);                       // [0xfa36a0] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/MagicLeap.InAppPurchaseComponent.GetPurchaseHistoryFailure__DelegateSignature
	// void GetPurchaseHistoryFailure__DelegateSignature();                                                                     // [0xfa36a0] MulticastDelegate|Public|Delegate 
	// Function /Script/MagicLeap.InAppPurchaseComponent.GetItemsDetailsSuccess__DelegateSignature
	// void GetItemsDetailsSuccess__DelegateSignature(TArray<FPurchaseItemDetails>& ItemsDetails);                              // [0xfa36a0] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/MagicLeap.InAppPurchaseComponent.GetItemsDetailsFailure__DelegateSignature
	// void GetItemsDetailsFailure__DelegateSignature();                                                                        // [0xfa36a0] MulticastDelegate|Public|Delegate 
};
...
{ 
public:
	SDK_UNDEFINED(16,406) /* FMulticastInlineDelegate */ __um(DeviceHasReactivatedDelegate);                       // 0x0140   (0x0010)  
	SDK_UNDEFINED(16,407) /* FMulticastInlineDelegate */ __um(DeviceWillEnterRealityModeDelegate);                 // 0x0150   (0x0010)  
	SDK_UNDEFINED(16,408) /* FMulticastInlineDelegate */ __um(DeviceWillGoInStandbyDelegate);                      // 0x0160   (0x0010)  
	SDK_UNDEFINED(16,409) /* FMulticastInlineDelegate */ __um(FocusLostDelegate);                                  // 0x0170   (0x0010)  
	SDK_UNDEFINED(16,410) /* FMulticastInlineDelegate */ __um(FocusGainedDelegate);                                // 0x0180   (0x0010)  
};
...
{ 
public:
	SDK_UNDEFINED(16,411) /* FMulticastInlineDelegate */ __um(OnHeadTrackingLost);                                 // 0x0140   (0x0010)  
	SDK_UNDEFINED(16,412) /* FMulticastInlineDelegate */ __um(OnHeadTrackingRecovered);                            // 0x0150   (0x0010)  
	SDK_UNDEFINED(16,413) /* FMulticastInlineDelegate */ __um(OnHeadTrackingRecoveryFailed);                       // 0x0160   (0x0010)  
	SDK_UNDEFINED(16,414) /* FMulticastInlineDelegate */ __um(OnHeadTrackingNewSessionStarted);                    // 0x0170   (0x0010)  
...
public:
	...
	// void SetStabilizationDepthActor(class AActor* InStabilizationDepthActor, bool bSetFocusActor);                           // [0xb0dc60] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.SetFocusActor
	// void SetFocusActor(class AActor* InFocusActor, bool bSetStabilizationActor);                                             // [0xb0dba0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.SetBaseRotation
	// void SetBaseRotation(FRotator& InBaseRotation);                                                                          // [0xb0db20] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.SetBasePosition
	// void SetBasePosition(FVector& InBasePosition);                                                                           // [0xb0db20] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.SetBaseOrientation
	// void SetBaseOrientation(FQuat& InBaseOrientation);                                                                       // [0xb0db20] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.SetAppReady
	// bool SetAppReady();                                                                                                      // [0xb0daf0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.IsRunningOnMagicLeapHMD
	// bool IsRunningOnMagicLeapHMD();                                                                                          // [0xb0d480] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetPlatformAPILevel
	// int32_t GetPlatformAPILevel();                                                                                           // [0xb0d3f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetMLSDKVersionRevision
	// int32_t GetMLSDKVersionRevision();                                                                                       // [0xb0d3f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetMLSDKVersionMinor
	// int32_t GetMLSDKVersionMinor();                                                                                          // [0xb0d3f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetMLSDKVersionMajor
	// int32_t GetMLSDKVersionMajor();                                                                                          // [0xb0d3f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetMLSDKVersion
	// FString GetMLSDKVersion();                                                                                               // [0xb0d370] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetMinimumAPILevel
	// int32_t GetMinimumAPILevel();                                                                                            // [0xb0d420] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetHeadTrackingState
	// bool GetHeadTrackingState(FMagicLeapHeadTrackingState& State);                                                           // [0xb0d2e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetHeadTrackingMapEvents
	// bool GetHeadTrackingMapEvents(TSet<EMagicLeapHeadTrackingMapEvent>& MapEvents);                                          // [0xb0d1e0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	// Function /Script/MagicLeap.MagicLeapHMDFunctionLibrary.GetGraphicsClientPerformanceInfo
	// bool GetGraphicsClientPerformanceInfo(FMagicLeapGraphicsClientPerformanceInfo& PerformanceInfo);                         // [0xb0d130] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
};
...
public:
	...
	SDK_UNDEFINED(16,415) /* FMulticastInlineDelegate */ __um(OnMeshTrackerUpdated);                               // 0x0200   (0x0010)  
	...
	// void SelectMeshBlocks(FMagicLeapTrackingMeshInfo& NewMeshInfo, TArray<FMagicLeapMeshBlockRequest>& RequestedMesh);       // [0xb0d9d0] Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.OnMeshTrackerUpdated__DelegateSignature
	// void OnMeshTrackerUpdated__DelegateSignature(FGuid ID, TArray<FVector>& Vertices, TArray<int32_t>& Triangles, TArray<FVector>& Normals, TArray<float>& Confidence); // [0xfa36a0] MulticastDelegate|Public|Delegate|HasOutParms|HasDefaults 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.GetNumQueuedBlockUpdates
	// int32_t GetNumQueuedBlockUpdates();                                                                                      // [0xb0d450] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.DisconnectMRMesh
	// void DisconnectMRMesh(class UMRMeshComponent* InMRMeshPtr);                                                              // [0xb0d0a0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.DisconnectBlockSelector
	// void DisconnectBlockSelector();                                                                                          // [0xb0d080] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.ConnectMRMesh
	// void ConnectMRMesh(class UMRMeshComponent* InMRMeshPtr);                                                                 // [0xb0cff0] Final|Native|Public|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapMeshTrackerComponent.ConnectBlockSelector
	// void ConnectBlockSelector(TScriptInterface<Class> Selector);                                                             // [0xb0cf50] Final|Native|Public|BlueprintCallable 
};
...
public:
	...
	// void SelectMeshBlocks(FMagicLeapTrackingMeshInfo& NewMeshInfo, TArray<FMagicLeapMeshBlockRequest>& RequestedMesh);       // [0xb0d8b0] Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// bool RequestRaycast(FMagicLeapRaycastQueryParams& RequestParams, FDelegateProperty& ResultDelegate);                     // [0xb0d760] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeap.MagicLeapRaycastComponent.RaycastResultDelegate__DelegateSignature
	// void RaycastResultDelegate__DelegateSignature(FMagicLeapRaycastHitResult HitResult);                                     // [0xfa36a0] Public|Delegate      
};
...
public:
	...
	// FMagicLeapRaycastQueryParams MakeRaycastQueryParams(FVector Position, FVector Direction, FVector UpVector, int32_t Width, int32_t Height, float HorizontalFovDegrees, bool CollideWithUnobserved, int32_t UserData); // [0xb0d4b0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
};
